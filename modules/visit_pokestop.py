from POGOProtos.Enums_pb2 import _ITEMCATEGORY
from POGOProtos.Map.Fort.FortType_pb2 import CHECKPOINT
...
class VisitPokestopModule(BaseModule):
    ...
    def execute(self):
        ...
        pokestops = [fort for fort in forts if fort.type is CHECKPOINT and
